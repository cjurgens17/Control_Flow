public class DoWhile {
    ...
    //the program will create a default constructor for us


    //we are not taking in any parameters into our method
    ...
    public void printValueIfTrue() {
        ...
        do {
            ...
            System.out.println("The do-while statement will always execute once");
        } while (check == true);
    }
}
